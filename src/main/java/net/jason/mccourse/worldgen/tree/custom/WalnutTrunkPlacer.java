package net.jason.mccourse.worldgen.tree.custom;
...
public class WalnutTrunkPlacer extends TrunkPlacer {
    public static final MapCodec<WalnutTrunkPlacer> CODEC = RecordCodecBuilder.mapCodec(walnutTrunkPlacerInstance ->
