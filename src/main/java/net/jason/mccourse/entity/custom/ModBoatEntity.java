...
public class ModBoatEntity extends Boat {
    private static EntityDataAccessor<Integer> DATA_ID_TYPE = SynchedEntityData.defineId(ModBoatEntity.class, EntityDataSerializers.INT);
    ...
    protected void defineSynchedData(SynchedEntityData.Builder pBuilder) {
        ...
        pBuilder.define(DATA_ID_TYPE, Type.WALNUT.ordinal());
    }
